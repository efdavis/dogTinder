...
const sequelize = new Sequelize(process.env.DB_DATABASENAME , process.env.DB_PASSWORD, process.env.DB_USERNAME , process.env.DB_PASSWORD, {host: process.env.DB_LOCALHOST, dialect: 'postgres', underscored: true});
